...
class TelaCadastroServico(QtWidgets.QMainWindow):
        ...
        def __init__(self):
                ...
                self.controller = ServicoController(view=self)
                self.setupUi()
        ...
        def addlinhaservico(self):
                ...
                self.gridLayout.addWidget(lineedit1, len(self.linhasservico)*2+1, 0, 1, 1)
                self.gridLayout.addWidget(lineedit2, len(self.linhasservico)*2+1, 1, 1, 1)
                self.linhasservico.append([lineedit1, lineedit2])
                self.gridLayout.addWidget(self.botaoadd, len(self.linhasservico)*2-1, 2, 1, 1)
        ...
        def resetarTela(self):
                ...
                self.labelnome = QtWidgets.QLabel(self.framedados, text="Descrição do serviço:")
                self.gridLayout.addWidget(self.labelnome, 0, 0, 1, 1)
