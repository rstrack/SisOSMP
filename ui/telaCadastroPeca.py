...
class TelaCadastroPeca(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.linhasPeca = [
            [self.lineEditDescricao, self.comboboxun, self.lineEditValorPeca]
        ]
        ...
        self.botaoHelp.clicked.connect(
            lambda: help("Ajuda - Cadastro de Peças", HELPCADASTROPECA)
        )
    ...
    def addLinhaPeca(self):
        ...
        self.gridLayout.addWidget(botaoRemoverLinha, len(self.linhasPeca) + 1, 3, 1, 1)
