...
class TelaVeiculoCliente(QtWidgets.QMainWindow):
    ...
    def renderVeiculos(self, idCliente):
        ...
        self.botaoHelp.clicked.connect(
            lambda: help("Ajuda - Veículos de um Cliente", HELPVEICULOS_CLIENTE)
        )
    ...
    def renderClientes(self, idVeiculo):
        ...
        self.botaoHelp.clicked.connect(
            lambda: help(
                "Ajuda - Clientes Vinculados a um Veículo", HELPCLIENTES_VEICULO
            )
        )
