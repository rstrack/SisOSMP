...
class TelaEditarOrcamento(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.gridLayoutGeral.addWidget(self.frameHelpVeiculo, 2, 0, 1, -1)
        ...
        self.gridLayoutGeral.addWidget(self.groupBoxPecas, 5, 0, 1, 1)
        ...
        self.gridLayoutGeral.addWidget(self.groupBoxServicos, 5, 1, 1, 1)
        ...
        self.gridLayoutGeral.addWidget(self.groupBoxObs, 7, 0, 1, -1)
        # botoes
        ...
        self.botaoRejeitar = QtWidgets.QPushButton(self.framebotoes)
        self.botaoRejeitar.setMinimumSize(130, 35)
        self.hlayout4.addWidget(self.botaoRejeitar)
        ...
        self.botaoRejeitar.clicked.connect(self.rejeitarOrcamento)
    ...
    def retranslateUi(self):
        ...
        self.botaoRejeitar.setText(_translate("MainWindow", "Não Aprovar"))
    ...
    def rejeitarOrcamento(self):
        try:
            ...
            if msgBox.clickedButton() == y:
                r = self.orcamentoCtrl.rejeitarOrcamento(self.orcamentoID)
                if isinstance(r, Exception):
                    raise Exception(r)
                msg = QtWidgets.QMessageBox()
                msg.setWindowIcon(QtGui.QIcon('resources/logo-icon.png'))
                msg.setIcon(QtWidgets.QMessageBox.Icon.Information)
                msg.setWindowTitle("Aviso")
                msg.setText("Orçamento não aprovado")
                msg.exec()
                self.paraTelaConsulta.emit(1)
        except Exception as e:
            msg = QtWidgets.QMessageBox()
